...
function WorkflowCard({workflow} : {workflow:Workflow}) {
  ...
  return (
    <Card className='border border-separate shadow-sm rounded-lg overflow-hidden hover:shadow-md dark:shadow-primary/30 ml-20 mr-10 group/card  '>
        <CardContent className='p-4 flex items-center justify-between h-[100px]'>
            <div className='flex items-center justify-end space-x-3'>
            <div
            className={cn(
                "w-10 h-10 rounded-full flex items-center b justify-center",
            ...
            <div>
                <h3 className='text-base font-bold text-muted-foreground flex items-center'>
                    ...
                    className="flex items-senter hover:underline">{workflow.name}
                    </Link>
                    </TooltipWrapper>
                    {isDraft && (
