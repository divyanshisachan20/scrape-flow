    ...
    <Card>
        ...
        <CardContent>
            <ChartContainer config={chartConfig} className='max-h-[200px] w-full' >
                ...
                <Area min={0} type={"natural"} fill='var(--color-success)' fillOpacity={0.6} stroke='var(--color-success)' dataKey={"success"} stackId={"a"}/>
                <Area min={0} type={"natural"} fill='var(--color-failed)' fillOpacity={0.6} stroke='var(--color-failed)' dataKey={"failed"} stackId={"a"}/>
