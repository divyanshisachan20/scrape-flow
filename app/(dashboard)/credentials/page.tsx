...
import DeleteCredentialwDialog from './_components/DeleteCredentialDialog'
...
export default function CredentialsPage() {
  return (
    <div className='flex flex-1 flex-col h-full'>
      ...
      <div className='h-full py-6 space-y-8 mx-20'>
        <Alert>
      ...
      {credentials.map((credential)=>{
        ...
        return (
          <Card key={credential.id} className='w-full p-4 flex justify-between'>
            ...
            <DeleteCredentialwDialog name={credential.name}/>
          </Card>
        )
      })}
    </div>
