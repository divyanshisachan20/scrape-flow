...
export async function ExecuteWorkflow(executionId:string,nextRunAt?:Date){
    ...
    await initialiseWorkflowExecution(executionId,execution.workflowId,nextRunAt);
    await initialisePhaseStatuses(execution)
    ...
    await finaliseWorkflowEExecution(executionId,execution.workflowId,executionFailed,creditsConsumed)
...
async function initialisePhaseStatuses(execution:any){
...
async function finaliseWorkflowEExecution(
    executionId:string,
    workflowId :string,
...
async function finalisePhase(phaseId:string,success:boolean,outputs:any,logCollector:LogCollector,creditsConsumed:number){
...
async function setupEnvironmentForPhase(node:AppNode,environment:Environment,edges:Edge[]){
